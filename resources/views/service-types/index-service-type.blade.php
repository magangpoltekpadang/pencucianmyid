...
@section('content')
    <div x-data="serviceTypeData()" x-init="init()" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="search" x-model="search" @change="fetchServiceTypes()"
                        @input="fetchServiceTypes()" placeholder="Type to search..."
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <template x-for="serviceType in serviceTypes" :key="serviceType.service_type_id">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"
                                    x-text="serviceType.code"></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                    x-text="serviceType.type_name"></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                    x-text="serviceType.description"></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        x-bind:class="serviceType.is_active ? 'bg-green-100 text-green-800' :
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="/service-types/${serviceType.service_type_id}/edit"
                        ...
                        <tr x-show="serviceTypes.length === 0">
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No Service Types Found
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    @push('scripts')
        <script src="{{ asset('js\service-types\service-type.script.js') }}"></script>
    @endpush
@endsection
