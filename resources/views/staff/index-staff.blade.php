...
@section('content')
    <div x-data="staffData()" x-init="init()" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-semibold text-gray-900"
                            x-text="staffs.filter(s => s.is_active).length">
                        </p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="search" x-model="search" @change="fetchStaffs()" @input="fetchStaffs()"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <template x-for="staff in staffs" :key="staff.staff_id">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"
                                    x-text="staff.name"></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="staff.email"></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="staff.phone_number">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="staff.outlet_id">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="staff.role_id">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        x-bind:class="staff.is_active ? 'bg-green-100 text-green-800' :
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a :href="`/staffs/${staff.staff_id}/edit`"
                                        class="text-blue-600 hover:text-blue-900 mr-3">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button @click="confirmDelete(staff.staff_id)" class="text-red-600 hover:text-red-900">
                        ...
                        <tr x-show="staffs.length === 0">
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No Staff Found
                            </td>
                        </tr>
                    </tbody>
                </table>
