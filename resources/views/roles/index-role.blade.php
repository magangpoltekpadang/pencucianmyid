        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="search" x-model="search" @change="fetchRoles()"
                        @input="fetchRoles()" placeholder="Type to search..."
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <template x-for="role in roles" :key="role.role_id">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                    x-text="role.description"></td>

                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="/roles/${role.role_id}/edit"
                                        class="text-blue-600 hover:text-blue-900 mr-3">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button @click="confirmDelete(role.role_id)"
                        ...
                        <tr x-show="roles.length === 0">
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No Role Found
                            </td>
                        </tr>
                    </tbody>
                </table>
