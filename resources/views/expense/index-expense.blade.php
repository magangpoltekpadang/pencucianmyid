...
@section('content')
    <div x-data="expenseData()" x-init="init()" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="search" x-model="search" @change="fetchExpenses()" @input="fetchExpenses()"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <template x-for="expense in expenses" :key="expense.expense_id">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.expense_code">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.outlet_id">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.expense_date">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.amount">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.category">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.description">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.staff_id">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="expense.shift_id">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a :href="`/expenses/${expense.expense_id}/edit`"
                                        class="text-blue-600 hover:text-blue-900 mr-3">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button @click="confirmDelete(expense.expense_id)" class="text-red-600 hover:text-red-900">
                        ...
                        <tr x-show="expenses.length === 0">
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No Expense Found
                            </td>
                        </tr>
                    </tbody>
                </table>
